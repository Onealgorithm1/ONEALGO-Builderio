    ...
    <Layout>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
              MarTech Services &nbsp;
              <span className="text-onealgo-orange-500">Marketing Technology that Scales</span>
            </h1>
            <p className="text-xl text-blue-200 max-w-3xl mx-auto mb-8">
              Use technology to make marketing faster, smarter, and more personalized — from automation and advertising to customer data platforms and integrations.
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">MarTech Capabilities</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              End-to-end MarTech solutions — automation, customer data, personalization, paid media, and integrations that deliver measurable ROI.
            </p>
          </div>
      ...
      <section className="py-20 bg-onealgo-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-3xl font-bold text-gray-900 mb-6">Why OneAlgorithm for MarTech?</h3>
              <ul className="space-y-4 text-gray-600">
                <li>Combine marketing strategy and engineering to deliver scalable, measurable programs.</li>
                <li>Centralize customer data to power personalization and better ad targeting.</li>
                <li>Automate repetitive tasks so your team focuses on strategy and growth.</li>
                <li>Transparent reporting, experimentation, and optimization for continuous improvement.</li>
              </ul>
            </div>

            <div className="bg-white rounded-lg shadow-lg p-8">
              <h4 className="text-2xl font-bold text-gray-900 mb-4">Get a MarTech Audit</h4>
              <p className="text-gray-600 mb-6">Our audit evaluates your stack, data flows, automation, and personalization readiness with prioritized recommendations and estimated impact.</p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-600 max-w-3xl mx-auto mb-8">Case studies and results from clients who used MarTech to drive growth — available on request.</p>
          <SocialShare />
        </div>
      </section>
    </Layout>
