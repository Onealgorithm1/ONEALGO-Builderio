...
import { DollarSign, Target, Zap, BarChart3, RefreshCw, Users } from "lucide-react";
    ...
    <Layout>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
              Google Ads Management &nbsp;
              <span className="text-onealgo-orange-500">Paid Search That Converts</span>
            </h1>
            <p className="text-xl text-blue-200 max-w-3xl mx-auto mb-8">
              Cut wasted spend and grow revenue with performance-focused Google Ads campaigns, expert optimization, and robust measurement.
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Google Ads Capabilities</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Full-service Google Ads: strategy, audience targeting, optimization, creative testing, and transparent reporting.
            </p>
          </div>
      ...
      <section className="py-20 bg-onealgo-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-3xl font-bold text-gray-900 mb-6">Why OneAlgorithm for Google Ads?</h3>
              <ul className="space-y-4 text-gray-600">
                <li>Performance-first approach focused on reducing CPA and increasing ROAS.</li>
                <li>Technical tracking and attribution to understand true campaign impact.</li>
                <li>Continuous testing and optimization of creatives and landing pages.</li>
                <li>Transparent reporting with clear recommendations and next steps.</li>
              </ul>
            </div>

            <div className="bg-white rounded-lg shadow-lg p-8">
              <h4 className="text-2xl font-bold text-gray-900 mb-4">Get a Google Ads Audit</h4>
              <p className="text-gray-600 mb-6">Our audit examines account structure, conversion tracking, audience strategy, and recommendations to lower CPA and improve performance.</p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h3 className="text-2xl font-bold mb-4">Paid Media Success Stories</h3>
          <p className="text-gray-600 max-w-3xl mx-auto mb-8">Examples of campaigns that scaled efficiently and delivered revenue — available on request.</p>
          <SocialShare />
        </div>
      </section>
    </Layout>
