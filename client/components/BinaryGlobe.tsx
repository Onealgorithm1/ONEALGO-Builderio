...
export default function BinaryGlobe({ size = "md", className = "" }: BinaryGlobeProps) {
  ...
  return (
    <div className={`${sizeClasses[size]} ${className} relative inline-block`}>
      <div className="w-full h-full relative overflow-hidden rounded-full bg-gradient-to-br from-onealgo-blue-400 via-onealgo-blue-600 to-onealgo-blue-950 shadow-lg">
